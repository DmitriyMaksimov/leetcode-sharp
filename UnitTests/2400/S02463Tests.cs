...
public class S02463Tests
{
    ...
    {
        var sut = new S02463();
        sut.MinimumTotalDistance([0, 4, 6], [[2, 2], [6, 2]]).Should().Be(4);
    }
    ...
    {
        var sut = new S02463();
        sut.MinimumTotalDistance([1, -1], [[-2, 1], [2, 1]]).Should().Be(2);
    }
    ...
    public void T3()
    {
        ...
        [
            ...
            425503766, 761908175
        ], [[-590277115, 0], [-80676932, 3], [396659814, 0], [480747884, 9], [118956496, 10]]).Should().Be(4412966458);
    }
}
