...
public class S00819Tests
{
    ...
    {
        var sut = new S00819();
        Assert.That(sut.MostCommonWord("Bob hit a ball, the hit BALL flew far after it was hit.", ["hit"]), Is.EqualTo("ball"));
    }
    ...
    {
        var sut = new S00819();
        Assert.That(sut.MostCommonWord("a.", []), Is.EqualTo("a"));
    }
    ...
    public void T3()
    {
        ...
        Assert.That(sut.MostCommonWord(
            ...
            ["m","q","e","l","c","i","z","j","g","t","w","v","h","p","d","b","a","r","x","n"]), Is.EqualTo("y"));
    }
}