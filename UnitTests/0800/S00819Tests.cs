...
[TestFixture]
public class S00819Tests
{
    [Test]
    public void T1()
    {
        var sut = new S00819();
        Assert.That(sut.MostCommonWord("Bob hit a ball, the hit BALL flew far after it was hit.", new[] {"hit"}), Is.EqualTo("ball"));
    }
    ...
    {
        var sut = new S00819();
        Assert.That(sut.MostCommonWord("a.", Array.Empty<string>()), Is.EqualTo("a"));
    }
    ...
    {
        var sut = new S00819();
        Assert.That(sut.MostCommonWord(
            ...
            new []{"m","q","e","l","c","i","z","j","g","t","w","v","h","p","d","b","a","r","x","n"}), Is.EqualTo("y"));
    }
}