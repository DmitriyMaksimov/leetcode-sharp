...
public class S00819Tests
{
    ...
    {
        var sut = new S00819();
        sut.MostCommonWord("Bob hit a ball, the hit BALL flew far after it was hit.", new[] {"hit"}).Should()
            .Be("ball");
    }
    ...
    {
        var sut = new S00819();
        sut.MostCommonWord("a.", Array.Empty<string>()).Should().Be("a");
    }
    ...
    public void T3()
    {
        ...
        sut.MostCommonWord(
            ...
            new []{"m","q","e","l","c","i","z","j","g","t","w","v","h","p","d","b","a","r","x","n"}).Should().Be("y");
    }
}