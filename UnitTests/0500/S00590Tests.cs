...
public class S00590Tests
{
    ...
    {
        var sut = new S00590();
        sut.Postorder(new S00590.Node(1,
                new List<S00590.Node?> {new(3, new List<S00590.Node?> {new(5), new(6)}), new(2), new(4)}))
            .Should().Equal(5, 6, 3, 2, 4, 1);
    }
    ...
    public void T4()
    {
        ...
        sut.Postorder(new S00590.Node(1,
            ...
            .Should().Equal(2, 6, 14, 11, 7, 3, 12, 8, 4, 13, 9, 10, 5, 1);
    }
}