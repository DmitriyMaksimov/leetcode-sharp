...
public class S01329Tests
{
    ...
    {
        var sut = new S01329();
        Assert.That(sut.DiagonalSort(new[] {new[] {3, 3, 1, 1}, new[] {2, 2, 1, 2}, new[] {1, 1, 1, 2}}), Is.EquivalentTo(new[]{new[] {1, 1, 1, 1}, new[] {1, 2, 2, 2}, new[] {1, 2, 3, 3}}));
    }
    ...
    {
        var sut = new S01329();
        Assert.That(sut.DiagonalSort(new[]
            {
